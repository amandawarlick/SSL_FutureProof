...
#batch 
batch <- 26   # 18 #10 and 14 and 18
thresh <- thresh_small
v_thresh <- 'small_decrease'

# batch <- 31 #23 #19 #11 and 15 and 19
# thresh <- thresh_big
# v_thresh <- 'big_decrease'

# batch <- 12
# thresh <- thresh_small
# v_thresh <- 'small_increase'
# 
# batch <- 13
# thresh <- thresh_big
# v_thresh <- 'big_increase'
...
pars.16 <- c(p.pars-p.pars*0.2, n.brand.50, c(rep(c(n.brand.50,0), (n.occasions/2)-1),n.brand.50,1))
pars.17 <- c(p.pars-p.pars*0.2, n.brand.75, c(rep(c(n.brand.75,0), (n.occasions/2)-1),n.brand.75,1))
pars.18 <- c(p.pars-p.pars*0.2, n.brand.100, c(rep(c(n.brand.100,0), (n.occasions/2)-1),n.brand.100,1))
pars.19 <- c(p.pars-p.pars*0.2, n.brand.150, c(rep(c(n.brand.150,0), (n.occasions/2)-1),n.brand.150,1))
pars.20 <- c(p.pars-p.pars*0.2, n.brand.200, c(rep(c(n.brand.200,0), (n.occasions/2)-1),n.brand.200,1))

pars.21 <- c(p.pars, n.brand.50, c(rep(c(n.brand.50,0), (n.occasions/2)-1),n.brand.50,1))
pars.22 <- c(p.pars, n.brand.75, c(rep(c(n.brand.75,0), (n.occasions/2)-1),n.brand.75,1))
pars.23 <- c(p.pars, n.brand.100, c(rep(c(n.brand.100,0), (n.occasions/2)-1),n.brand.100,1))
pars.24 <- c(p.pars, n.brand.150, c(rep(c(n.brand.150,0), (n.occasions/2)-1),n.brand.150,1))
pars.25 <- c(p.pars, n.brand.200, c(rep(c(n.brand.200,0), (n.occasions/2)-1),n.brand.200,1))

pars.26 <- c(p.pars+p.pars*0.2, n.brand.50, c(rep(c(n.brand.50,0), (n.occasions/2)-1),n.brand.50,1))
pars.27 <- c(p.pars+p.pars*0.2, n.brand.75, c(rep(c(n.brand.75,0), (n.occasions/2)-1),n.brand.75,1))
pars.28 <- c(p.pars+p.pars*0.2, n.brand.100, c(rep(c(n.brand.100,0), (n.occasions/2)-1),n.brand.100,1))
pars.29 <- c(p.pars+p.pars*0.2, n.brand.150, c(rep(c(n.brand.150,0), (n.occasions/2)-1),n.brand.150,1))
pars.30 <- c(p.pars+p.pars*0.2, n.brand.200, c(rep(c(n.brand.200,0), (n.occasions/2)-1),n.brand.200,1))
...
#batch 12 & 13
# inc_little5[s,] <- phi.pars <= 
#         c(quantile(out_mat[,'mean.phiP.15'], probs = 0.05), 
#           quantile(out_mat[,'mean.phi1.15'], probs = 0.05),
#           quantile(out_mat[,'mean.phi2.15'], probs = 0.05),
#           quantile(out_mat[,'mean.phiJ.15'], probs = 0.05),
#           quantile(out_mat[,'mean.phiA.15'], probs = 0.05))
# colnames(inc_little5) <- phi.pars.names
# 
# inc_little10[s,] <- phi.pars <= 
#         c(quantile(out_mat[,'mean.phiP'], probs = 0.05), 
#           quantile(out_mat[,'mean.phi1'], probs = 0.05),
#           quantile(out_mat[,'mean.phi2'], probs = 0.05),
#           quantile(out_mat[,'mean.phiJ'], probs = 0.05),
#           quantile(out_mat[,'mean.phiA'], probs = 0.05))
# colnames(inc_little10) <- phi.pars.names


} #simulations

# save output
saveRDS(bias, file = here::here('results', 'simpleAge', 'sims', 'prePop',
                                paste('S.', scenario, '_bias', batch, '.rds', sep = '')))
saveRDS(out_median, file = here::here('results', 'simpleAge', 'sims', 'prePop',
                                      paste('S.', scenario,  '_median', batch, '.rds', sep = '')))
saveRDS(cv, file = here::here('results', 'simpleAge', 'sims',  'prePop',
                                      paste('S.', scenario,  '_cv', batch, '.rds', sep = '')))
saveRDS(rmse, file = here::here('results', 'simpleAge', 'sims',  'prePop',
                                      paste('S.', scenario,  '_rmse', batch, '.rds', sep = '')))

#batch 10 & 14 & 18 & 22
saveRDS(dec_little10, file = here::here('results', 'simpleAge', 'sims', 'prePop',
                                      paste('S.', scenario,  '_dec_little10_', batch, '.rds', sep = '')))
saveRDS(dec_little5, file = here::here('results', 'simpleAge', 'sims', 'prePop',
...
# 
# saveRDS(dec_big10, file = here::here('results', 'simpleAge', 'sims', 'prePop',
#                                       paste('S.', scenario,  '_dec_big10_', batch, '.rds', sep = '')))
# saveRDS(dec_big5, file = here::here('results', 'simpleAge', 'sims', 'prePop',
#                                       paste('S.', scenario,  '_dec_big5_', batch, '.rds', sep = '')))

# #batch 12
# saveRDS(inc_little10, file = here::here('results', 'simpleAge', 'sims', 
#                                       paste('S.', scenario,  '_inc_little10_', batch, '.rds', sep = '')))
# saveRDS(inc_little5, file = here::here('results', 'simpleAge', 'sims', 
#                                       paste('S.', scenario,  '_inc_little5_', batch, '.rds', sep = '')))
# 
# #batch 13
# # inc_big5 <- inc_little5
# # inc_big10 <- inc_little10
# saveRDS(inc_big10, file = here::here('results', 'simpleAge', 'sims', 'prePop',
#                                       paste('S.', scenario,  '_inc_big10_', batch, '.rds', sep = '')))
# saveRDS(inc_big5, file = here::here('results', 'simpleAge', 'sims', 'prePop',
#                                       paste('S.', scenario,  '_inc_big5_', batch, '.rds', sep = '')))

saveRDS(out, file = here::here('results', 'simpleAge', 'sims',  'prePop',
