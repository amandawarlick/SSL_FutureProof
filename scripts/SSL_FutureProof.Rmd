...
out <- readRDS(here::here('results', 'out_ME_fixed_sd_simpleBacktrans.RDS'))
...
out_plots <- list(out$samples$chain1, out$samples$chain2, out$samples$chain3) %>% as.mcmc.list()

plot(out_plots[,c('int.phiP', 'int.phi1', 'int.phi2', 'int.phi3', 'int.phi4', 'int.phi5', 
                  'int.phi6', 'int.phi7', 'int.phi8', 'int.phi9', 'int.phiA')])

plot(out_plots[,c('b.sexP[2]', 'b.sex1[2]', 'b.sex2[2]', 'b.sex3[2]', 'b.sex4[2]',
                  'b.sex5[2]', 'b.sex6[2]', 'b.sexA[2]')])
plot(out_plots[,c('b.siteP[2]', 'b.site1[2]', 'b.site2[2]', 'b.siteJ[2]', 'b.siteA[2]')])
