...
#         c(quantile(out_mat[,'mean.phiP.5'], probs = 0.05), 
#           quantile(out_mat[,'mean.phi1.5'], probs = 0.05),
#           quantile(out_mat[,'mean.phi2.5'], probs = 0.05),
#           quantile(out_mat[,'mean.phiJ.5'], probs = 0.05),
#           quantile(out_mat[,'mean.phiA.5'], probs = 0.05))
...
# saveRDS(inc_big10, file = here::here('results', 'simpleAge', 'sims', 
#                                       paste('S.', scenario,  '_inc_big10_', batch, '.rds', sep = '')))
# saveRDS(inc_big5, file = here::here('results', 'simpleAge', 'sims', 
