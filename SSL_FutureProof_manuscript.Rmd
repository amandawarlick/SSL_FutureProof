...
Title: 
- Optimizing mark-resight survey design for demographic estimation
- Other suggestions....? 

Authors: Amanda J. Warlick, Brian Fadely, Peter Mahony, Sharon Melin, Tom Gelatt, Kim Raum-Suryan, Sarah J. Converse
...
- Future work would benefit from X (incorporting costs)
- Benefits of incorproating costs
-- Goals have to be re-evaluated in iterative process
-- Citations of spatially-explicit 

- Evans et al - species recovery in the U.S. (evans et al. 2016)
- Recommendations for mark-resight designs generally -- more quantitative demography in rec plans? 
- Implementation of "monitoring" and triggers thereof
