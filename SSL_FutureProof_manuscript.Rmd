...
effort_cv_dot <- ggplot(effort_cv_dat %>% filter(!is.na(step)) %>%
  ...
  theme(legend.position = 'top',
        strip.background = element_rect(fill = "white", color = "black"),
        legend.text = element_text(size = 10, vjust = 0.5, family = 'Sans'),
        axis.title.x = element_text(vjust = -1, family = 'Sans'),
        legend.title = element_text(vjust = 0.8, size = 10, family = 'Sans')) +
